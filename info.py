...
API_ID = int(environ.get('API_ID', '26837402'))
API_HASH = environ.get('API_HASH', '85610a45e9d8c44a7a842cdf6e338b20')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002461043781'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6425654239').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002314317246').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bocem72608:bocem72608@cluster0.jjwvc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://bocem72608:bocem72608@cluster0.jjwvc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie748')
